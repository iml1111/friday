...
>
> ✅ **업스트림 적용 완료** — 2026-07-22, friday `26b0ced` (테스트 11종 이식 + docs 01·CLAUDE.md 갱신 포함)
...
| 4 | `system_sections` · `turn_sections` 훅 | §5.3 | ✅ **적용 완료** (2026-07-22, `26b0ced`) | 범용 확장점으로 실전 검증(장부 실험이 SDK 포크 없이 수행·revert됨). API 면 확장 논의 후 "프롬프트 조립 machinery"의 확장으로 수용 |
